...
#if LOAD_BGRA
    fp=fopen("/home/justin/ClionProjects/VideoAudioDemo/resource/test_bgra_320x180.rgb","rb+");
#elif LOAD_RGB24
    fp=fopen("/home/justin/ClionProjects/VideoAudioDemo/resource/test_rgb24_320x180.rgb","rb+");
#elif LOAD_BGR24
    fp=fopen("/home/justin/ClionProjects/VideoAudioDemo/resource/test_bgr24_320x180.rgb","rb+");
#elif LOAD_YUV420P
	fp=fopen("/home/justin/ClionProjects/VideoAudioDemo/resource/test_yuv420p_320x180.yuv","rb+");
#endif
    if(fp==NULL){
